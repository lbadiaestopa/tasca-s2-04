...
db.restaurants.find({ "address.street": { $in: [null, ""] }}, { _id: 0, address: 1 })
...
db.restaurants.find({ name: {$regex: /mon/i }}, { _id: 0, name: 1, borough: 1, "location.coordinates.0": 1, "location.coordinates.1": 1, cuisine: 1 })
